...
\begin{theorem}\label{thm:linear-dependence-subset}
  Let $(V, +, \cdot)$ be a vector space, and let $R \subseteq S \subseteq V$.
  Then the following statements are true.
  \begin{enumerate}
    \item If $R$ is linearly dependent, then $S$ is linearly dependent.
    \item If $S$ is linearly independent, then $R$ is linearly independent.
  \end{enumerate}
\end{theorem}
\begin{proof} \leavevmode
  \begin{enumerate}
    \item If $R$ is linearly dependent, then there exists $x \in R$ such that
      ...
      linearly dependent.
    \item Suppose that $S$ is linearly independent.
      If $R$ is linearly dependent, then $S$ is linearly dependent by (a),
      contradiction.
      Thus, $R$ is linearly independent. \qedhere
  \end{enumerate}
\end{proof}